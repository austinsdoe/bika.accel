...
class BikaTestLayer(PloneSandboxLayer):
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'bika.accel:default')
        ...
        self.request.form['existing'] = "bika.accel:test"
