...
bikaMessageFactory = MessageFactory('bika.accel')

# we import the configuration module, in order to have access to the variables it contains
from bika.accel import config

import logging
logger = logging.getLogger('Bika ACCEL')

# importing some useful stuff from the Archetypes API
from Products.Archetypes.atapi import process_types, listTypes
from Products.CMFCore import utils

# We also need to define permissions for the content types
